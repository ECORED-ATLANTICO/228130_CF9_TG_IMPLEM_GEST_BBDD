    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-8(data-aos="fade-left")
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
          div(titulo="¿Qué es?")
            p Es una herramienta que vigila y gestiona cambios en un sistema de archivos; de igual manera, un VCS monitorizará las adiciones, eliminaciones y modificaciones en las líneas de texto que contiene el archivo.
              br
              br
              |Es la práctica de rastrear y gestionar los cambios en el código de <em>software</em>; los sistemas de control de versiones son <em>software</em> que mejoran a los equipos de <em>software</em> al gestionar los cambios en el código fuente a lo largo del tiempo; estos entornos se aceleran y los sistemas de control mejoran los tiempos en la gestión de los proyectos. (Dauzon, 2022).
          div(titulo="Utilizado para")
            p Son especialmente utilizados para equipos de <em>DevOps</em>, ya que permiten reducir tiempo en el desarrollo; también se puede decir que se realizan seguimientos a las modificaciones del código en un tipo especial de bases de datos; en este, si se comete un error en la codificación, los desarrolladores pueden ir a sus versiones anteriores y hacer comparaciones para ayudar a resolver los errores, lo que permite minimizar las interrupciones a todos los miembros del equipo.
              br
              br
              |Para los proyectos de desarrollo de <em>software</em> el código fuente es fundamental, ya que se convierte en un activo valioso cuyo valor debe protegerse; es por eso que el control de versiones protege el código tanto de las catástrofes como del deterioro causal de los errores y consecuencias accidentales.
          ...
          .contenedor-dashed.p-4
            .bg-white.p-4
              p.mb-0 Estos repositorios son instalaciones virtuales donde se almacenan investigaciones científicas según su temática multidisciplinaria; estos pueden ser de tres tipos como: repositorios institucionales que son creados por las propias empresas para almacenar, usar y preservar a producción científica; también se encuentran repositorios temáticos que fueron creados por investigadores o instituciones, que reúnen información en un área específica; por último, se tienen los repositorios de datos que almacenan, conservan y comparten los datos de las investigaciones. (Dauzon, 2022).
                ...
                br
                br
                |También se puede mencionar que un repositorio Git es un almacenamiento virtual para la gestión de un proyecto, esto porque permite guardar versiones del código a las que se puede acceder cuando se necesite. Git almacena las opciones de configuración en tres archivos, lo que permite el ajuste individual local, global y de sistema; en conclusión, todas las opciones de configuración se almacenan en archivos de texto sin formato, así que el comando Git <em>config</em> en realidad no es más que una interfaz práctica de línea de comandos. En entrega continua se mejora la productividad del desarrollo ya que se reducen los errores y los <em>bugs</em> enviados a los clientes; también se optimizan los tiempos de encontrar errores gracias a la realización de pruebas, lo que permite al equipo de producción entregar las actualizaciones de manera rápida.
    .row.justify-content-center.mb-5
      ...
      .col-lg-8(data-aos="fade-left")
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
          div(titulo="Git <em> init</em>")
            p Para crear un nuevo repositorio se usa el comando Git <em>Init</em>, este es un comando que se utiliza una vez durante la configuración inicial. Cuando se ejecuta este comando se creará un nuevo subdirectorio git en el repositorio actual; también se creará una nueva rama principal.
          div(titulo="Git <em> clone</em>")
            p Si se quiere clonar un repositorio existente se hace mediante el comando Git <em>clone</em>; la clonación suele ser una operación única; todas las operaciones de control de versiones se administran por medio de su repositorio local.
          div(titulo="Git <em> add</em>")
            p Para guardar cambios en el repositorio se usa el comando Git <em>add</em>; pero antes se pueden realizar commits en la versión del archivo, los pasos que se deben hacer son los siguientes:
            ul.lista-ul--color
              li
                i.fas.fa-check.fa-xs(style="color: #084a93")
                p.mb-0 Cambiar el directorio a <em>/path/to/proyect</em>.

              li
                i.fas.fa-check.fa-xs(style="color: #084a93")
                p.mb-0 Crear un archivo nuevo comminttest.txt con el contenido <em>“Test”</em>.

              li
                i.fas.fa-check.fa-xs(style="color: #084a93")
                p.mb-0 Ejecutar el comando Git <em>add</em> para añadir committest.txt al área de preparación del repositorio.

              li
                i.fas.fa-check.fa-xs(style="color: #084a93")
                p.mb-0 Crear un <em>commit</em> nuevo con un mensaje que describa qué trabajo se ha hecho en el <em>commit</em>.
            p Es importante diferenciar las copias de trabajo en Git de las copias de trabajo al extraer código fuente de un repositorio SVN; a diferencia de SVN, Git no distingue entre las copias de trabajo y el repositorio central, es por eso que colaborar con Git es distinto que con SVN.
          ...
          div(titulo="Git <em> push -u</em>")
            p Este comando enviará la rama del repositorio local, además de la configuración de la URL del repositorio remoto, este puede pedir configurar ajustes como el <em>username</em> o el <em>email</em>. El comando Git <em>config</em> permite configurar la instalación de Git desde la línea de comandos, este comando puede definir ciertos ajustes, desde la información del usuario hasta las preferencias o el comportamiento del repositorio.
      .col-lg-4.col-8(data-aos="fade-right")
