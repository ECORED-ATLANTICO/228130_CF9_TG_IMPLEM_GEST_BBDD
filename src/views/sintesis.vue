...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-md-10.mb-5
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="Computación en la nube: 1. Inteligencia artificial. 2. Centro de datos. 3. Contenedores. 4. Máquinas virtuales. 5. Almacenamiento. 6. Seguridad.")
