      ...
      .col-lg-10
        ...
        ImagenInfografica.color-secundario.mb-5
          ...
          .tarjeta.color-acento-contenido.p-3.text-black(x="23.5%" y="13%" numero="+")
            h4.mb-2 SaaS
            p <em>Software</em> como servicio (SaaS); en este los proveedores ofrecen a sus clientes servicios de niveles de aplicación según la necesidad de cada empresa, como lo es el (CRM) o gestión de relaciones con clientes, orientación al <em>marketing</em> y análisis empresarial.
          ...
          .tarjeta.color-acento-contenido.p-3.text-black(x="75.5%" y="13%"  numero="+")
            h4.mb-2 laaS
            p Infraestructura como servicio (IaaS); este es un centro de datos seguro, ya que permite acceder a recursos primarios como lo son la capacidad de almacenamiento de datos, procesamiento y conectividad en la red.
